        ...
        <div class={tw`bg-white min-h-screen`}>
          <main
            ...
            <header class={tw`pt-10 pb-9 sm:pb-16 sm:text-center`}>
              <h1 class={tw`mb-4 text-3xl sm:text-4xl tracking-tight font-extrabold`}>
                Blog
              </h1>
              <p class={tw`text-lg`}>
              ...
              {this.props.data.map((el: any) => (
                <article class={tw`relative flex flex-col max-w-3xl lg:ml-auto xl:max-w-none xl:w-[50rem]`}>
                  ...
                  <div class={tw`mt-auto flex flex-row-reverse items-center justify-end`}>
                    <div class={tw`text-sm leading-6 lg:absolute lg:top-0 lg:right-full lg:mr-8 lg:whitespace-nowrap`}>
                      January, 12 2030
                    </div>
                    <Link
                      to={"/blog/" + el.title}
                      class={tw`px-6 py-2 text-sm font-semibold text-blue-800 bg-blue-100`}>
                      Read More
                    </Link>
                  </div>
                </article>
